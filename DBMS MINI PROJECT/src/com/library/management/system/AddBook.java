...
public class AddBook extends JFrame implements ActionListener{
    ...
    public AddBook() {
        ...
        JLabel l8=new JLabel("Book Copies");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            Conn con = new Conn();
            if(ae.getSource() == b1){
                String sql = "insert into books(book_id, name, isbn, publisher, edition, price, pages,no_of_copies )" +
                             "values(?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                st.setInt(8, Integer.parseInt(t7.getText()));
    ...
    public static void main(String[] args) { new AddBook().setVisible(true); }
}
